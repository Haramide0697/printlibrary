                        ...
                        <form method="get">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <input type="hidden" name="mod" value="book" class="form-control">
...
if (isset($_GET['title']) && isset($_GET['author']) && isset($_GET['classmark']) && isset($_GET['an']) && isset($_GET['department']) && isset($_GET['publisher']) && isset($_GET['pop']) && isset($_GET['yop']) && isset($_GET['subject']) && isset($_GET['description'])) {
    ...
    $pagelink = "?mod=book&link=search&title=$stitle&author=$sauthor&classmark=$sclassmark&an=$san&department=$sdepartment&publisher=$spublisher&pop=$spop&yop=$syop&subject=$ssubject&description=$sdescription";
