...
?>            
                ...
                <!-- View New Journal Area Start Here -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                                ...
                                $fetch = $conn->query("SELECT * FROM journals ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                                $result = $fetch->fetchAll(PDO::FETCH_OBJ);
                                $count = $fetch->rowCount();
                                $sn = $offset+1;
                                if ($count > 0) {
                            ...
                            <ul class="pagination">
                                <?php // if($page_no > 1){ echo "<li><a href='?mod=journal&link=view&page_no=1'>First Page</a></li>"; } ?>
                                
                                <li <?php if($page_no <= 1){ echo "class='disabled'"; } ?>>
                                <a <?php if($page_no > 1){ echo "href='?mod=journal&link=view&page_no=$previous_page'"; } ?>>Previous</a>
                                </li>
                                ...
                                if ($total_no_of_pages <= 10){       
                                    for ($counter = 1; $counter <= $total_no_of_pages; $counter++){
                                       ...
                                       echo "<li><a href='?mod=journal&link=view&page_no=$counter'>$counter</a></li>";
                                            }
                                    }
                                }
                                ...
                                if($page_no <= 4) {         
                                 for ($counter = 1; $counter < 8; $counter++){       
                                    ...
                                    echo "<li><a>...</a></li>";
                                    echo "<li><a href='?mod=journal&link=view&page_no=$second_last'>$second_last</a></li>";
                                    echo "<li><a href='?mod=journal&link=view&page_no=$total_no_of_pages'>$total_no_of_pages</a></li>";
                                    }

                                 elseif($page_no > 4 && $page_no < $total_no_of_pages - 4) {         
                                    echo "<li><a href='?mod=journal&link=view&page_no=1'>1</a></li>";
                                    echo "<li><a href='?mod=journal&link=view&page_no=2'>2</a></li>";
                                    echo "<li><a>...</a></li>";
                            ...
                            ?>
                                ...
                                <a <?php if($page_no < $total_no_of_pages) { echo "href='?mod=journal&link=view&page_no=$next_page'"; } ?>>Next</a>
                                </li>
                                <?php if($page_no < $total_no_of_pages){
                                    echo "<li><a href='?mod=journal&link=view&page_no=$total_no_of_pages'>Last &rsaquo;&rsaquo;</a></li>";
                                    } ?>
                            </ul>
